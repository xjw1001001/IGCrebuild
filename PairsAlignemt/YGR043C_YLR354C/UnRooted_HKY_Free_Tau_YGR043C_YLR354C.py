...
if __name__=='__main__':
    ...
    dataloc = './YGR043C_YLR354C_input.fasta'
    paralog_pair = ['YGR043C','YLR354C']
    ...
    Model = 'HKY'
    guess = np.log([0.49063051,   0.52677502,   0.37278418,   8.45263599])
    ...
    r1 = test.estimate(args, Model, guess_w_blen,output = './UnRootedTest_HKY'+'_'.join(test.paralog)+'_Free_Tau.txt', est_blen = True, clock = False,print_result = True)

    test.save_to_file('./YGR043C_YLR354C_UF_HKY_Class.p')
