...
if __name__=='__main__':
    ...
    r1 = test.estimate(args, Model, guess_w_blen,output = './UnRootedTest_HKY'+'_'.join(test.paralog)+'_Force_Tau.txt',force_tau = True, est_blen = True, clock = False,print_result = True)

    test.save_to_file('./YMR143W_YDL083C_U0_HKY_Class.p')
