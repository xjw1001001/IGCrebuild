...
#paml.summary.file <- paste(path.HKY, "paml_summary.txt", sep = "")
...
#path.hessian <- "G:/Geneconv/DataFiles/"
...
write.table(filtered.pairs, "/Users/xji3/Genconv/NewClusterPackRun/Yeast14pairs")
```
...
Compare posterior geneconv events & posterior edge specific tau estimate with the expected Pdiff of the MG94 + IGC model
given the MLE.
